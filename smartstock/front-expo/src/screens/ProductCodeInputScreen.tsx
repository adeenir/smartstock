        ...
        <Div style={{flex: 1, justifyContent: 'flex-start', alignItems: 'center'}}>
          <Div style={{height: 320, justifyContent: 'center', alignItems: 'center', marginTop: 100}}>
            ...
            <Div style={{
              ...
              <Icon name="bottle-water" size={130} color="#38410B" iconStyle="solid" />
            </Div>
            <Text fontWeight="bold" color="#38410B" mt={-1} style={{textAlign: 'center', fontSize: 20}}>Guaraná</Text>
            <Text color="#38410B" style={{textAlign: 'center', fontSize: 16}}>Quantidade: 1</Text>
            <Text color="#38410B" fontSize="sm" style={{textAlign: 'center', fontSize: 14}}>Data de fabricação: 16/05/25</Text>
            <Text color="#38410B" fontSize="sm" style={{textAlign: 'center', fontSize: 14}}>Data de validade: 16/06/25</Text>
          </Div>
        </Div>
        <Div px="xl" style={{position: 'absolute', left: 0, right: 0, bottom: 88}}>
          <TouchableOpacity style={[styles.button, {height: 52}]} onPress={handleAddToStock}>
            <Text color="white" fontWeight="bold" fontSize={16}>Adicionar ao estoque</Text>
          </TouchableOpacity>
        </Div>
    ...
    return (
      <Div flex={1} bg="white">
        ...
        <Div flex={1} alignItems="center" justifyContent="center" px="xl">
          <Icon name="circle-check" size={80} color="#38410B" style={{marginBottom: 24}} />
          <Text fontWeight="bold" fontSize="lg" color="#38410B" mb="lg">PRODUTO ADICIONADO COM SUCESSO!</Text>
          <TouchableOpacity onPress={() => navigation.navigate('Stock')} style={{marginTop: 8}}>
            <Text color="#38410B" fontWeight="bold" textDecorLine="underline">Acesse seu estoque</Text>
          </TouchableOpacity>
        </Div>
        <BottomBar navigation={navigation} />
      </Div>
      ...
      <Div flex={1} bg="white">
        ...
        <Div flex={1} px="xl" justifyContent="flex-start" style={{marginTop: 48}}>
          ...
          <TouchableOpacity onPress={handleClear} style={{marginTop: 12, marginBottom: 32}}>
            <Text color="#38410B" fontWeight="bold" fontSize="sm">Limpar campos</Text>
          </TouchableOpacity>
          <TouchableOpacity
            ...
            disabled={code === ''}
          >
            <Text color="white" fontWeight="bold">Avançar</Text>
          </TouchableOpacity>
        </Div>
        <BottomBar navigation={navigation} />
      </Div>
